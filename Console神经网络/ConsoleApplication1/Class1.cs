...
namespace BpANNet
{
    ...
    public class BpNet
    {
        ...
        public int computeHideNum(int m, int n)//确定隐藏节点数
        {
        ...
        public BpNet(double[,] p, double[,] t)
        {
         ...
         //  make  Console.ReadLine();
            ...
            x = new double[inNum]; //将这些矩阵规定好矩阵大小
